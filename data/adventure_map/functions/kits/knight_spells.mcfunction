...
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Basic Sword"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=knight] container.0 with minecraft:stone_sword{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:5s},{id:"minecraft:sweeping",lvl:1s} ], display:{ Name:'{"italic":false,"text":"Basic Sword"}', Lore:[ '{"text":"Knight: Sword"}', '{"text":"Knight: Slot 1"}' ] }} 1
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Cast-Iron Sword"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=knight] container.0 with minecraft:iron_sword{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:5s},{id:"minecraft:sweeping",lvl:1s} ], display:{ Name:'{"italic":false,"text":"Cast-Iron Sword"}', Lore:[ '{"text":"Knight: Sword"}', '{"text":"Knight: Slot 1"}' ] }} 1
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Sandesite Sword"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=knight] container.0 with minecraft:golden_sword{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:10s},{id:"minecraft:sweeping",lvl:2s} ], display:{ Name:'{"italic":false,"text":"Sandesite Sword"}', Lore:[ '{"text":"Knight: Sword"}', '{"text":"Knight: Slot 1"}' ] }} 1  
# Trident drop protection
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Depths\' Curse 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 with minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Depths\' Curse 1"}', Lore:[ '{"italic":false,"color":"white","text":"Spear deals physical damage to whatever it hits."}','{"italic":false,"color":"white","text":"Deals 6 magic damage to enemies within 4 blocks"}','{"italic":false,"color":"white","text":"  and applies 10 seconds of slowness."}','{"italic":false,"color":"blue","text":"Cost: 400MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Depths\' Curse"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Mob Hook 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 with minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Mob Hook 1"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a hook that pulls mobs towards you,"}','{"italic":false,"color":"white","text":"  and deals physical damage."}','{"italic":false,"color":"blue","text":"Cost: 350MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Mob Hook Spell"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1   
# Ground Pound spell
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Ground Pound 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=knight] container.1 with minecraft:anvil{Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Ground Pound 1"}', Lore:[ '{"italic":false,"color":"white","text":"Leap in the air and slam back down,"}','{"italic":false,"color":"white","text":"  launching nearby enemies airborne and"}','{"italic":false,"color":"white","text":"  dealing 20 physical damage."}','{"italic":false,"color":"white","text":"Grants temporary invulnerability while leaping."}','{"italic":false,"color":"blue","text":"Cost: 600MP"}', '{"text":"Knight: Active Spell"}', '{"text":"Knight: Ground Pound Spell"}', '{"text":"Knight: Slot 2"}' ] }} 1
...
execute at @a[scores={shield_used=1..}] run effect give @e[distance=0..3,tag=Enemies] slowness 5
item replace entity @a[scores={spell.11.uses=8}] weapon.offhand with shield{Damage:1,Enchantments:[{id:unbreaking,lvl:400}]}
item replace entity @a[scores={spell.11.uses=7}] weapon.offhand with shield{Damage:42,Enchantments:[{id:unbreaking,lvl:400}]}
item replace entity @a[scores={spell.11.uses=6}] weapon.offhand with shield{Damage:83,Enchantments:[{id:unbreaking,lvl:400}]}
item replace entity @a[scores={spell.11.uses=5}] weapon.offhand with shield{Damage:124,Enchantments:[{id:unbreaking,lvl:400}]}
item replace entity @a[scores={spell.11.uses=4}] weapon.offhand with shield{Damage:165,Enchantments:[{id:unbreaking,lvl:400}]}
item replace entity @a[scores={spell.11.uses=3}] weapon.offhand with shield{Damage:206,Enchantments:[{id:unbreaking,lvl:400}]}
item replace entity @a[scores={spell.11.uses=2}] weapon.offhand with shield{Damage:247,Enchantments:[{id:unbreaking,lvl:400}]}
item replace entity @a[scores={spell.11.uses=1}] weapon.offhand with shield{Damage:288,Enchantments:[{id:unbreaking,lvl:400}]}
...
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Shield 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=knight] container.1 with minecraft:iron_door{Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Shield 1"}', Lore:[ '{"italic":false,"color":"white","text":"Grants a shield that blocks 4 melee hits, lasting 20s."}','{"italic":false,"color":"white","text":"Slows nearby enemies when the shield is used."}','{"italic":false,"color":"white","text":"Can\'t block ranged projectiles or area attacks."}','{"italic":false,"color":"blue","text":"Cost: 300MP"}', '{"text":"Knight: Active Spell"}', '{"text":"Knight: Shield Spell"}', '{"text":"Knight: Slot 2"}' ] }} 1
# Set up spell success temp var
scoreboard players set @a[tag=knight] fine_hp.tmp0 0
...
# Depth's Curse
execute as @e[tag=replenish_3,nbt={Trident:{tag:{display:{Name:'{"italic":false,"text":"Depths\' Curse 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 with minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Depths\' Curse 1"}', Lore:[ '{"italic":false,"color":"white","text":"Spear deals physical damage to whatever it hits."}','{"italic":false,"color":"white","text":"Deals 6 magic damage to enemies within 4 blocks"}','{"italic":false,"color":"white","text":"  and applies 10 seconds of slowness."}','{"italic":false,"color":"blue","text":"Cost: 400MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Depths\' Curse"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1 
scoreboard players set @a[tag=knight] fine_hp.tmp0 0
...
# Mob Hook
execute as @e[tag=replenish_3,nbt={Trident:{tag:{display:{Name:'{"italic":false,"text":"Mob Hook 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 with minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Mob Hook 1"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a hook that pulls mobs towards you,"}','{"italic":false,"color":"white","text":"  and deals physical damage."}','{"italic":false,"color":"blue","text":"Cost: 350MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Mob Hook Spell"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1 
scoreboard players set @a[tag=knight] fine_hp.tmp0 0
...
execute as @e[tag=hit_trident,tag=depths_curse] at @s run scoreboard players operation @e[tag=Enemies,distance=0..4] fine_hp.mdmg += @s spell.8.power
