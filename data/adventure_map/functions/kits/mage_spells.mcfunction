...
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Basic Staff"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=mage] container.0 with minecraft:golden_hoe{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:3s} ], display:{ Name:'{"italic":false,"text":"Basic Staff"}',Lore:['{"text":"Mage: Staff"}','{"text":"Mage: Slot 1"}'] }} 1
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Fiery Staff"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=mage] container.0 with minecraft:golden_hoe{Unbreakable:1,HideFlags:5, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}], display:{ Name:'{"italic":false,"text":"Fiery Staff"}', Lore:[ '{"text":"Mage: Staff"}',  '{"text":"+8 Fireball Magic Damage"}', '{"text":"Mage: Slot 1"}' ] } } 1
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Whirlwind Staff"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=mage] container.0 with minecraft:golden_hoe{Unbreakable:1,HideFlags:6, Enchantments:[{id:"minecraft:sharpness",lvl:1s}], display:{ Name:'{"italic":false,"text":"Whirlwind Staff"}', Lore:[ '{"italic":false,"color":"white","text":"Attacks faster."}', '{"text":"Mage: Staff"}',  '{"text":"+1 Zephyr Speed"}',  '{"text":"+2 Melee Splash Damage"}', '{"text":"Mage: Slot 1"}','{"text":""}','{"italic":false,"color":"gray","text":"When in main hand:"}','{"italic":false,"color":"dark_green","text":" 8 Attack Speed"}','{"italic":false,"color":"dark_green","text":" 2 Attack Damage"}' ] }, AttributeModifiers:[ {AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:4,Operation:0,UUIDLeast:595046,UUIDMost:291484,Slot:"mainhand"} ]} 1
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Embiggened Staff"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=mage] container.0 with minecraft:golden_hoe{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:5s} ], display:{ Name:'{"italic":false,"text":"Embiggened Staff"}', Lore:[ '{"italic":false,"color":"white","text":"Is bigger. Apparently."}', '{"text":"Mage: Staff"}', '{"text":"Mage: Slot 1"}' ] }} 1  
# Fireball spell
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Fireball 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=mage] container.1 with minecraft:blaze_rod{HideFlags:1, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}], display:{ Name:'{"italic":false,"text":"Fireball 1"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a fireball that explodes on contact or after 0.5s,"}','{"italic":false,"color":"white","text":"  dealing 3 physical damage and 8 magic damage."}','{"italic":false,"color":"white","text":"Damage decreases with distance from explosion center."}','{"italic":false,"color":"white","text":"A direct hit does even more damage."}','{"italic":false,"color":"white","text":"Can hurt self and allies!"}','{"italic":false,"color":"blue","text":"Cost: 200MP"}', '{"text":"Mage: Primary Spell"}', '{"text":"Mage: Fireball Spell"}', '{"text":"Mage: Slot 2"}' ] }} 1
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Fireball 2"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=mage] container.1 with minecraft:blaze_rod{HideFlags:1, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}], display:{ Name:'{"italic":false,"text":"Fireball 2"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a fireball that explodes on contact or after 0.5s,"}','{"italic":false,"color":"white","text":"  dealing 3 physical damage and 8 magic damage."}','{"italic":false,"color":"white","text":"Damage decreases with distance from explosion center."}','{"italic":false,"color":"white","text":"A direct hit does even more damage."}','{"italic":false,"color":"white","text":"Can hurt self and allies!"}','{"italic":false,"color":"blue","text":"Cost: 200MP"}', '{"text":"Mage: Primary Spell"}',  '{"text":"Mage: Fireball Spell"}',  '{"text":"+8 Fireball Magic Damage"}', '{"text":"Mage: Slot 2"}' ] }} 1
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Cyclone Spear 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=mage] container.1 with minecraft:feather{HideFlags:1, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}], display:{ Name:'{"italic":false,"text":"Cyclone Spear 1"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a straight projectile, dealing 25 damage."}','{"italic":false,"color":"white","text":"Can be stopped by thick crowds."}','{"italic":false,"color":"blue","text":"Cost: 500MP"}', '{"text":"Mage: Primary Spell"}', '{"text":"Mage: Cyclone Spear Spell"}', '{"text":"Mage: Slot 2"}' ] }} 1 
...
execute as @e[tag=mage_fireball] store result entity @s Motion[0] double 0.02 run scoreboard players get @s fine_hp.tmp0
execute as @e[tag=mage_fireball] store result entity @s Motion[2] double 0.02 run scoreboard players get @s fine_hp.tmp2 
...
execute as @e[tag=mage_wind_spear] at @s run scoreboard players operation @e[distance=0..2,tag=Enemies,tag=windSpeared] fine_hp.tmp0 = @s fine_hp.tmp4
execute as @e[tag=mage_wind_spear] at @s run execute as @e[distance=0..2,tag=Enemies,tag=windSpeared] run scoreboard players operation @s fine_hp.tmp0 -= @s spell.2.power
execute as @e[tag=mage_wind_spear] at @s run scoreboard players operation @e[distance=0..2,tag=Enemies,tag=windSpeared,scores={fine_hp.tmp0=1..}] fine_hp.mdmg += @s spell.2.power
execute as @e[tag=mage_wind_spear] at @s run execute at @e[distance=0..2,tag=Enemies,tag=windSpeared,scores={fine_hp.tmp0=1..}] run scoreboard players remove @s fine_hp.tmp3 1
execute as @e[tag=mage_wind_spear] at @s run scoreboard players operation @e[distance=0..2,tag=Enemies] spell.2.power = @s fine_hp.tmp4
execute as @e[tag=mage_wind_spear] at @s run scoreboard players operation @e[distance=0..2,tag=Enemies,tag=!windSpeared] fine_hp.mdmg += @s spell.2.power
execute as @e[tag=mage_wind_spear] at @s run execute at @e[distance=0..2,tag=Enemies,tag=!windSpeared] run scoreboard players remove @s fine_hp.tmp3 1
execute as @e[tag=mage_wind_spear] at @s run tag @e[distance=0..2,tag=Enemies,tag=!windSpeared] add windSpeared 
scoreboard players remove @e[tag=mage_wind_spear] fine_hp.tmp3 1
kill @e[tag=mage_wind_spear,scores={fine_hp.tmp3=..0}] 
execute as @e[tag=mage_wind_spear] at @s run execute as @e[distance=0..2,tag=Enemies] store result score @s fine_hp.tmp0 run data get entity @s Motion[0] 500
execute as @e[tag=mage_wind_spear] at @s run execute as @e[distance=0..2,tag=Enemies] store result score @s fine_hp.tmp2 run data get entity @s Motion[2] 500
execute as @e[tag=mage_wind_spear] at @s run scoreboard players operation @e[distance=0..2,tag=Enemies] fine_hp.tmp0 += @s fine_hp.tmp0
execute as @e[tag=mage_wind_spear] at @s run scoreboard players operation @e[distance=0..2,tag=Enemies] fine_hp.tmp2 += @s fine_hp.tmp2
execute as @e[tag=mage_wind_spear] at @s run execute as @e[distance=0..2,tag=Enemies] store result entity @s Motion[0] double 0.002 run scoreboard players get @s fine_hp.tmp0
execute as @e[tag=mage_wind_spear] at @s run execute as @e[distance=0..2,tag=Enemies] run data modify entity @s Motion[1] set value 0.25
execute as @e[tag=mage_wind_spear] at @s run execute as @e[distance=0..2,tag=Enemies] store result entity @s Motion[2] double 0.002 run scoreboard players get @s fine_hp.tmp2 
# Zephyr spell
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Zephyr 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=mage] container.2 with minecraft:magma_cream{HideFlags:1, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}], display:{ Name:'{"italic":false,"text":"Zephyr 1"}', Lore:[ '{"italic":false,"color":"white","text":"Grant Speed II to caster for 5 seconds."}','{"italic":false,"color":"white","text":"Grant Strength I to caster and allies for 5 seconds."}','{"italic":false,"color":"white","text":"Grant Speed I to caster and allies for 80 seconds."}','{"italic":false,"color":"blue","text":"Cost: 500MP"}', '{"text":"Mage: Secondary Spell"}', '{"text":"Mage: Zephyr Spell"}', '{"text":"Mage: Slot 3"}' ] }} 1 
...
# Discharge spell
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Discharge 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=mage] container.2 with minecraft:end_rod{HideFlags:1, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}], display:{ Name:'{"italic":false,"text":"Discharge 1"}', Lore:[ '{"italic":false,"color":"white","text":"Deal 3 magic damage and Stun nearby enemies."}','{"italic":false,"color":"white","text":"Grant Strength I to nearby players for 5 seconds."}','{"italic":false,"color":"blue","text":"Cost: 500MP"}',  '{"text":"Mage: Secondary Spell"}',  '{"text":"Mage: Discharge Spell"}', '{"text":"Mage: Slot 3"}' ] }} 1 
...
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Arcane Explosion 1"}'}}}}] at @s store success score @s replenish_ok run item replace entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=mage] container.2 with minecraft:nether_star{HideFlags:1, Enchantments:[{id:"minecraft:unbreaking",lvl:1s}], display:{ Name:'{"italic":false,"text":"Arcane Explosion 1"}', Lore:[ '{"italic":false,"color":"white","text":"Push enemies away."}','{"italic":false,"color":"blue","text":"Cost: 400MP"}', '{"text":"Mage: Secondary Spell"}', '{"text":"Mage: Arcane Explosion Spell"}', '{"text":"Mage: Slot 3"}' ] }} 1 
scoreboard players set @a[tag=mage] fine_hp.tmp0 0
...
execute as @e[tag=arcane_explode] at @s store result score @e[tag=Enemies,distance=0..8] fine_hp.tmp1 run data get entity @s Pos[0] 100
execute as @e[tag=arcane_explode] at @s store result score @e[tag=Enemies,distance=0..8] fine_hp.tmp2 run data get entity @s Pos[2] 100
execute as @e[tag=arcane_explode] at @s run scoreboard players operation @e[tag=Enemies,distance=0..7] fine_hp.mdmg += @s fine_hp.tmp0
execute at @e[tag=arcane_explode] run tag @e[tag=Enemies,distance=0..7] add repulsed 
